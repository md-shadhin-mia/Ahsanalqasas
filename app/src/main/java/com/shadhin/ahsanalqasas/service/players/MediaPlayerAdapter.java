...
package com.shadhin.ahsanalqasas.service.players;
...
import com.shadhin.ahsanalqasas.MainActivity;
import com.shadhin.ahsanalqasas.service.PlaybackInfoListener;
import com.shadhin.ahsanalqasas.service.PlayerAdapter;
...
public final class MediaPlayerAdapter extends PlayerAdapter {
    ...
    public void playFromMedia(MediaMetadataCompat metadata) {
        ...
        playFile(QuranAudioLibrary.getInstance().getMusicFilename(mediaId));
    }
    ...
    private void playFile(String filename) {
        ...
        try {
            ...
            for(String file : sdCard.list()){
                Log.d("ENTERNALSTORAGE", file);
            }
            String path = sdCard.getAbsolutePath()+"/computer software/audio/" + mFilename;
