...
package com.shadhin.ahsanalqasas.client;
...
public class MediaBrowserHelper {
    ...
    private List<MediaBrowserCompat.MediaItem> LoadedChildren;
    ...
    public List<MediaBrowserCompat.MediaItem> getLoadedChildren(){
